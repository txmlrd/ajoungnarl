...
const Footer = () => {
  return (
    <div className="flex flex-col items-center justify-center pt-10 ">
      <div className="flex lg:flex-row flex-col gap-5 justify-between w-full py-10 border-y border-gray-300">
        <div className="flex flex-col gap-1 w-2/3 lg:mx-30 mx-10">
        ...
        <div className="flex lg:flex-row flex-col justify-between w-1/3 gap-5 lg:mx-30 mx-10">
