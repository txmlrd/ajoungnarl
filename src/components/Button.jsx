  ...
  return (
    <div className="w-full flex justify-center ">
      <Link to={path || ""} className={`justify-center items-center flex ${wFull ? "w-full" : ""}`}>
        <button onClick={onClick} className={`flex flex-row items-center justify-center gap-2 px-[20px] py-[8px] outline-1 outline-black hover:bg-[#BCBCBC] transition-all w-full ${className}`} disabled={disabled}>
